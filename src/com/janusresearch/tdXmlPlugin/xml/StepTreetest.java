...
public class StepTreetest {
    ...
    public StepTreetest(XmlRoot xmlRoot) {
        root = xmlRoot;
        setNodes();
        setNodeAttributes();
        setOldNodeValues();
    ...
    /** Store the reference to every nodes attribute in the nodeAttributes array */
    private void setNodeAttributes() {
